...
public class GameGuessNumber {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            int zadaneCisloPouzivatelom = 0;
            try {
                zadaneCisloPouzivatelom = scn.nextInt(); // Priamo v konzole zobrazi, resp. pozaduje zadanie cisla
            } catch (InputMismatchException e) {
                System.out.println("Chyba pri zadávaní textu. Namiesto čísla bola vstupom textová hodnota!");
                break;
            } catch (Exception e) {
